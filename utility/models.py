...
class Inspection(models.Model):
    ...
    OUTDOOR_NA_CHOICE = ("na_outdoor_site", "Not Applicable(OUTDOOR SITE)")
    COND_CHOICES = [("working","Working"), ("not_working","Not Working"), ("not_available","Not Available")]
    COND_CHOICES_WITH_OUTDOOR = COND_CHOICES + [OUTDOOR_NA_CHOICE]
    AC_STATUS_CHOICES = [
        ("working", "Working"),
    ...
    power_factor = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    contract_demand = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    ...
    diesel_balance = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    ...
    fire_extinguisher_condition = models.CharField(max_length=20, choices=COND_CHOICES_WITH_OUTDOOR, null=True, blank=True)
    aircondition_status = models.CharField(max_length=20, choices=AC_STATUS_CHOICES, null=True, blank=True)
    free_cooling_status = models.CharField(max_length=20, choices=COND_CHOICES_WITH_OUTDOOR, null=True, blank=True)
    overall_site_cleanliness = models.CharField(max_length=10, choices=CLEAN_CHOICES, null=True, blank=True)
    spare_unused_items_available = models.TextField(blank=True, null=True)
